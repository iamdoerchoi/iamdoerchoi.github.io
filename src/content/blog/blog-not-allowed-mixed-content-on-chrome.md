...
description: '강의를 보고 그대로 AWS CloudFront로 파일 업로드 페이지를 구축, AWS Elastic Beanstalk로 파일 저장 API 서버를 구축했다. 그런데 화면과 다르게 나는'
pubDate: 'Jan 28 2022'
emoji: '👀'
tags: 'BLOG'
---
...
![error_message](/images/error-msg.png)
...
![network_tab](/images/network_tab.png)
