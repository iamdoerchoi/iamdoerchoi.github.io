...
description: '기존 1차 때 만든 [9k밥](https://github.com/joong8812/9kbab)을 업그레이드 하는 방향으로 진행하기로 했고, 또 이미 한 번 합을 맞춰 보았기 때'
pubDate: 'Jan 18 2022'
emoji: '🙋🏻‍♂️'
tags: 'KPT PROJECT'
---
...
4. 음식 사진 인식 모델(InceptionV3) - InceptionV3 모델을 바탕으로 82개의 라벨을 가진 음식 사진을 학습 시켜 자동 추천 태그 구현 - `82.57%` 정확도 - train_data_set: 70,547 개 - test_data_set: 12,521 개
   ![사진](/images/auto-recommend-tag.gif)
...
- 3주간 머물렀던 공부방 📚 (Feat. 다희님 축캐인증)
  ![사진](/images/9velopment_graduation1.png)
- 9velopment + 9k밥 로고 🍲
  ![사진](/images/9velopment_graduation2.png)
