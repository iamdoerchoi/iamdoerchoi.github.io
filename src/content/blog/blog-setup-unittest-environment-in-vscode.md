...
description: '오늘 수업시간에 Django에서 테스트코드를 작성하고 명령어 $python manage.py test 로 테스트 하는 법을 배웠다. 그리고 Pycharm에서 간단하게 설정 몇개'
pubDate: 'Feb 11 2022'
emoji: '🙌'
tags: 'BLOG'
---
