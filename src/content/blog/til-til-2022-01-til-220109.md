---
title: 'Job리스트 스크래핑 - 1'
description: '과일예측 딥러닝 모델(기존 Perceptron 모델을 Transfer Learning(전이학습))을 학습시키는 데 굉장히 시간(약 8시간)이 오래 걸려 수업진도를 못나가던 찰나 팀'
pubDate: 'Jan 09 2022'
emoji: '🔖'
...
[![노마드코더_채용리스트_컨테스트](/images/contest.png)](https://nomadcoders.co/community/thread/1623)
