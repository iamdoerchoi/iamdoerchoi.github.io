---
title: '데이터베이스 간 관계'
description: '우선 위키피디아(Wikipedia) [정의](<https://en.wikipedia.org/wiki/One-to-many_(data_model)>)를 보자.'
pubDate: 'Jan 21 2022'
emoji: '💿'
tags: 'TIL DJANGO DB'
---
...
- 관계도 이미지
  ![many-to-many1](/images/many-to-many1.png)  
  ![many-to-many2](/images/many-to-many2.png)
