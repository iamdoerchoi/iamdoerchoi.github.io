---
title: 'TCP와 UDP'
description: '우리가 현재 사용하고 있는 인터넷은 TCP/IP모델을 따르고 있다. 아래 흐름도를 보고 어떻게 통신이 이루어지는 지 파악하고 이후에는 전송계층에서 쓰이는 TCP와 UDP의 특징과'
pubDate: 'Apr 21 2022'
emoji: '🪵'
tags: 'TIL NETWORK'
---
...
![tcp-ip-model-work-flow](/images/tcp-ip-model-work-flow.jpeg)
